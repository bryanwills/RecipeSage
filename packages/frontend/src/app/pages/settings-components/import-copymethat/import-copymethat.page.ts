...
@Component({
  standalone: true,
  selector: "page-import-copymethat",
  templateUrl: "import-copymethat.page.html",
  styleUrls: ["import-copymethat.page.scss"],
  imports: [
    ...SHARED_UI_IMPORTS,
    IonHeader,
    IonToolbar,
...
export class ImportCopymethatPage {
  ...
  async submit() {
    ...
    const response = await this.importService.importCopymethat(
      this.file,
      undefined,
      (event) => {
